function [figh,h, p] = compare2(group1, group2, conditions, ylbl, dim, markSz, color1, color2)
       ...
       errorbar([0.75], mean1, std1,'LineStyle', 'none','LineWidth',1,'Color',color1,'CapSize',0,'Marker','.','MarkerSize',meanMarkSize);
       errorbar([1.5], mean2, std2,'LineStyle', 'none','LineWidth',1,'Color',color2,'CapSize',0,'Marker','.','MarkerSize',meanMarkSize);
       xlim([0.25 2]);
       ylim([0 inf])
       xticks([0.75 1.5]);
