function [h, p] = compare2(group1, group2, conditions, ylbl, dim, markSz, color1, color2)
       ...
       h = figure;
       scatter(1*ones(m,1), group1',markSize,l_grey,'filled','jitter','on', 'jitterAmount',0.1);
       hold on;
        plot([1*ones(m,1) 2*ones(m2,1)]',[group1' group2']','Color',l_grey); % for lines
       scatter(2*ones(m2,1), group2',markSize,l_grey,'filled','jitter','on', 'jitterAmount',0.1);
