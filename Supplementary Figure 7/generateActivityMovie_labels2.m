function generateActivityMovie_labels2(img,labels,positiveIndices,name,clims)
...
%                 name = name of file to output
    ...
    for i = 1:size(img,3)
        indx_green = find(labels(:,i)>=1); % which labels are active
