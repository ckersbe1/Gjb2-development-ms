function [p, handle] = compare3(group1, group2, group3, conditions, ylbl, dim, markSz, color1, color2)
...
%        
      ...
      % errorbar([3.5], mean4, std4,'LineStyle', 'none','LineWidth',2,'Color',color1,'CapSize',0,'Marker','.','MarkerSize',meanMarkSize);
       plot([1 2]',[mean1 mean2]','Color',color1);
       plot([2 3]',[mean2 mean3]','Color',color1);
