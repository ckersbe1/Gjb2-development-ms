function [h, p, handle] = compare8(group1, group2, group3, group4,group5,group6,group7,group8,conditions, ylbl, dim, markSz, color1, color2)
...
%        scatter(7.5*ones(m9,1), group9,markSize,l_grey,'filled');
    ...
    %   scatter(7*ones(m6,1), group6,markSize,l_grey,'filled');
     ...
     errorbar([8], mean8, std8,'LineStyle', 'none','LineWidth',2,'Color',color1,'CapSize',0,'Marker','.','MarkerSize',meanMarkSize);
...
plot([7 8]',[mean7 mean8]','LineWidth',2,'Color',color1);
